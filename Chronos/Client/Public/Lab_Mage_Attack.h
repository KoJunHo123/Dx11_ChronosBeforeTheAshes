...
class CLab_Mage_Attack final : public CPartObject
{
public:
...
private:
	CLab_Mage_Attack(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CLab_Mage_Attack(const CLab_Mage_Attack& Prototype);
	virtual ~CLab_Mage_Attack() = default;
